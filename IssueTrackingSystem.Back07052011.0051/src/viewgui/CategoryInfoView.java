...
public class CategoryInfoView extends JPanel implements IObserver {
    ...
    private JLabel TotalSubCat, TotalArticles, CummTotalArticles, CatDescription;
    ...
    private void displayInformationForCategory(Category currentSelectedCategory) {
        if (currentSelectedCategory != null){
            ...
            CatDescription.setText(currentSelectedCategory.getCatDescription());
        }
    }
    ...
    private void initValueLabels() {
        ...
        CatDescription = new JLabel("  " + DEFAULT_NO_CATEGORY_SELECTED);
        CatDescription.setOpaque(true);
        CatDescription.setBackground(Color.WHITE);
        Border borderCatDescription = BorderFactory.createLineBorder(Color.BLACK);
        CatDescription.setBorder(borderCatDescription);
    }
    ...
    private void initializeLabels(){
        ...
        CatDescription.setBackground(Color.WHITE);
        CatDescription.setHorizontalAlignment(SwingConstants.LEFT);
        CatDescription.setVerticalAlignment(SwingConstants.TOP);
        CatDescription.setName("CatDescription"); 
        CatDescription.setOpaque(true);
    ...
    public JPanel getCatPanel(){
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(CatDescription, GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
            .addComponent(CatDescription, GroupLayout.PREFERRED_SIZE, 84, GroupLayout.PREFERRED_SIZE)
            .addGap(11, 11, 11))
        );
