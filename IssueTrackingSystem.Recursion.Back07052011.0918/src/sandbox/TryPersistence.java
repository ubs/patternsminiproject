...
public class TryPersistence {
    ...
    public static void main(String[] args) {
        ...
        //Testing Model to Persitence (XML)
        IDebug.print( CategoryModel.getInstance().toPersistenceString() );
        IDebug.print( ArticleModel.getInstance().toPersistenceString() );
        IDebug.print( AppConfigModel.getInstance().toPersistenceString() );
