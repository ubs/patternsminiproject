...
public class ArticlesView extends JPanel implements IObserver, ListSelectionListener {
    ...
    private JPanel panelArticlesList;
    private ArticleDetailsView panelArticlesDetails;
    private JSplitPane splitPaneArtListArtDetails;
    ...
    private void setupArticlesJList() {
        ...
        Border articlesListPaddingBorder = BorderFactory.createEmptyBorder(0,5,0,0);
        articlesList.setBorder(articlesListPaddingBorder);
    ...
    private void displayArticle(Article article){
        ...
        panelArticlesDetails.displayArticleDetails(article);
    }
